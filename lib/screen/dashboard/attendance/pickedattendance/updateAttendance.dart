...
class UpdateAttendance extends StatefulWidget {
  UpdateAttendance({super.key});

  @override
  State<UpdateAttendance> createState() => _UpdateAttendance();
}

class _UpdateAttendance extends State<UpdateAttendance> {
      ...
      body: StreamBuilder(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            var model = snapshot.data!.result!
                .where((att) => att.attendaceType == "PICKED")
                .toList();
            return Padding(
